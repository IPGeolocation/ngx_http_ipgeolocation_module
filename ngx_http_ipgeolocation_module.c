 ...
 */
 ...
 static ngx_http_ipgeo_var_t  ngx_http_ipgeo_vars[] = {
     ...
     { "ip_country_capital",
         { {"location","country","capital","en",NULL}, {"country","capital","en",NULL}, {"country_capital","en",NULL} } },
     { "ip_continent_code",
         { {"location","country","continent","code",NULL}, {"country","continent","code",NULL}, {"continent_code",NULL} } },
     { "ip_continent_name",
         { {"location","country","continent","name","en",NULL}, {"country","continent","name","en",NULL}, {"continent_name","en",NULL} } },
     { "ip_currency_code",
         { {"location","country","currency","code",NULL}, {"country","currency","code",NULL}, {"currency","code",NULL} } },
     { "ip_currency_name",
         { {"location","country","currency","name","en",NULL}, {"country","currency","name","en",NULL}, {"currency","name",NULL} } },
     { "ip_currency_symbol",
         { {"location","country","currency","symbol",NULL}, {"country","currency","symbol",NULL}, {"currency","symbol",NULL} } },
     { "ip_calling_code",
         { {"location","country","metadata","calling_code",NULL}, {"country","metadata","calling_code",NULL}, {"calling_code",NULL} } },
     { "ip_languages",
         { {"location","country","metadata","languages",NULL}, {"country","metadata","languages",NULL}, {"languages",NULL} } },
     { "ip_tld",
         { {"location","country","metadata","tld",NULL}, {"country","metadata","tld",NULL}, {"tld",NULL} } },
 
     /* ---- Location: state / district / city ------------------------------ */
     { "ip_state_code",
         { {"location","state","code",NULL}, {"state_code",NULL} } },
     { "ip_state_name",
         { {"location","state","name","en",NULL}, {"state_prov","en",NULL}  } },
     { "ip_district_name",
         { {"location","district","name","en",NULL}, {"district","en",NULL} } },
     { "ip_city_name",
     ...
     { "ip_geoname_id",
         { {"location","geoname_id",NULL}, {"geoname_id",NULL} } },
     { "ip_time_zone",
     ...
     /* ---- ASN ------------------------------------------------------------ */
     { "ip_asn",
         { {"asn","as_number",NULL}, {"asn",NULL}, {"as_number",NULL} } },
     { "ip_asn_organization",
